...
personalInfo.favoriteFoods.forEach(food => {
...
personalInfo.placesLived.forEach((location) => {
    let placeElement = document.createElement("dt")
    let lengthElement = document.createElement("dd")
    placeElement.textContent = location.place
    lengthElement.textContent = location.length
